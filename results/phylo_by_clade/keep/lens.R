...
t.test(lH3K27me3_bordergenes$LEN,lnonH3K27me3_genes$LEN)
t.test(lH3K27me3_genes$LEN,lnonH3K27me3_genes$LEN)
k27yes <- subset(lH3K27me3_genes$LEN,lH3K27me3_genes$LEN < 4000)
k27no  <- subset(lnonH3K27me3_genes$LEN,lnonH3K27me3_genes$LEN < 4000)

t.test(k27yes,k27no)
ks.test(k27yes,k27no)
